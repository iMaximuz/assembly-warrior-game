...
"{",
	...
	"vec2 rotatedUV = vec2(c * (gl_PointCoord.x - 0.5) + s * (gl_PointCoord.y - 0.5) + 0.5,", 
    	...
    	"vec4 rotatedTexture = vec4(1.0, 1.0, 1.0, 1.0);//vec4 rotatedTexture = texture2D( texture,  rotatedUV );",
...
function ParticleEngine()
{
	...
	this.particleGeometry.addAttribute('position', new THREE.BufferAttribute(new Float32Array([]), 3));	
	this.particleGeometry.addAttribute('customVisible', new THREE.BufferAttribute(new Float32Array([]), 1));
	this.particleGeometry.addAttribute('customAngle', new THREE.BufferAttribute(new Float32Array([]), 1));
	this.particleGeometry.addAttribute('customSize', new THREE.BufferAttribute(new Float32Array([]), 1));
	this.particleGeometry.addAttribute('customColor', new THREE.BufferAttribute(new Float32Array([]), 3));
	this.particleGeometry.addAttribute('customOpacity', new THREE.BufferAttribute(new Float32Array([]), 1));
...
ParticleEngine.prototype.initialize = function(scene)
{
	...
	for (var i = 0; i < this.particleCount; i++)
	{
		...
		this.particleGeometry.attributes.position.array[i] = this.particleArray[i].position;
		this.particleGeometry.attributes.customVisible.array[i] = this.particleArray[i].alive;
		this.particleGeometry.attributes.customColor.array[i]   = this.particleArray[i].color;
